...
#define KEYBOARD_INITIAL_X_POSITION 22
#define KEYBOARD_INITIAL_Y_POSITION 555
#define KEYBOARD_INITIAL_SIZE_X 550
#define KEYBOARD_INITIAL_SIZE_Y 300
...
WidgetKeyboard::WidgetKeyboard(QWidget *parent) : QWidget(parent)
{
    ...
    // NEM - Did these to disable parts of the keyboard we don't need
    horizontalLayout_10->setParent(NULL);
    verticalLayout->setParent(NULL);
    horizontalLayout_9->setParent(NULL);
    frameNumPad->setParent(NULL);

    btnTilt->setParent(NULL);
    btnHiphen->setParent(NULL);
    btnAssign->setParent(NULL);
    btnTab->setParent(NULL);
    btnCaps->setParent(NULL);
    btnShiftLeft->setParent(NULL);
    btnCtrlLeft->setParent(NULL);
    btnAltLeft->setParent(NULL);
    btnBcwdSlash->setParent(NULL);
    btnComma->setParent(NULL);
    btnSemiColon->setParent(NULL);
    btnSp->setParent(NULL);
    btnFwdSlash->setParent(NULL);
    btnCloseSquare->setParent(NULL);
    btnStartSquare->setParent(NULL);
    btn1->setParent(NULL);
    btn2->setParent(NULL);
    btn3->setParent(NULL);
    btn4->setParent(NULL);
    ...
    resize(KEYBOARD_INITIAL_SIZE_X,
           KEYBOARD_INITIAL_SIZE_Y);
    move(KEYBOARD_INITIAL_X_POSITION,
         KEYBOARD_INITIAL_Y_POSITION);
